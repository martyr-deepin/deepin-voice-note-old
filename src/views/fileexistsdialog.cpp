...
{
    m_dialog = UiUtil::createChooseDialog(QString(""), QString(tr("The file name already exists. Do you want to replace the file?")), nullptr, QString(tr("Confirm")), QString(tr("Cancel")));
